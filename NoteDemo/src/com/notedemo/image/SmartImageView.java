...
public class SmartImageView extends ImageView {
	...
	public void setImageUrl(String url, final Integer fallbackResource,
			final Integer loadingResource, final Integer width,
			final Integer length) {
		setImage(new WebImage(url), fallbackResource, loadingResource, width,
				length);
	}
	...
	public void setImageUrl(String url, final Integer fallbackResource,
			final Integer loadingResource, boolean autoRotate) {
		setImage(new WebImage(url, autoRotate), fallbackResource,
				loadingResource);
	}
	...
	public void setImage(final SmartImage image,
			final Integer fallbackResource, final Integer loadingResource,
			final Integer width, final Integer length) {
		// Set a loading resource
		if (loadingResource != null) {
			setImageResource(loadingResource);
		}
		...
		currentTask
				.setOnCompleteHandler(new SmartImageTask.OnCompleteHandler() {
					...
					public void onComplete(Bitmap bitmap) {
						if (bitmap != null) {
							bitmap = zoomBitmap(bitmap, width, length);
							setImageBitmap(bitmap);
						} else {
							// Set fallback resource
							if (fallbackResource != null) {
